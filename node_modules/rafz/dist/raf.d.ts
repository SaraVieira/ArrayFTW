declare type NativeRaf = (cb: () => void) => void;
interface Timeout {
    time: number;
    handler: () => void;
    cancel: () => void;
...
declare type Throttled<T extends VoidFn> = T & {
    handler: T;
    cancel: () => void;
};
/**
 ...
 */
declare type FrameUpdateFn = (dt: number) => boolean | void;
/**
 * Return true to be called again next frame.
 */
declare type FrameFn = () => boolean | void;
interface Rafz {
...
export { FrameFn, FrameUpdateFn, Throttled, Timeout, __raf, raf };
