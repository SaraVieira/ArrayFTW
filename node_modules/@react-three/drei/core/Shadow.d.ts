...
export declare const Shadow: React.ForwardRefExoticComponent<Pick<Omit<import("@react-three/fiber/dist/declarations/src/three-types").Node<Mesh<import("three").BufferGeometry, import("three").Material | import("three").Material[]>, typeof Mesh>, import("@react-three/fiber/dist/declarations/src/three-types").NonFunctionKeys<{
